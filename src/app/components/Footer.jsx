...
export default function Footer() {
  ...
  return (
    <footer
      style={{
        marginTop: 32,
        borderTop: "6px solid #d9c29a", // franja clara como en la imagen
        background: bg,
        color: "#fff",
      }}
    >
      ...
      >
        ...
        {/* Headquarters */}
        <div>
          <div style={labelStyles}>Headquarters</div>
        ...
        {/* Contact */}
        <div>
          <div style={labelStyles}>Contact Us</div>
          <div style={textStyles}>
            <a
              href="mailto:media@theheritageguardian.com"
              style={{ color: "#fff", textDecoration: "none", borderBottom: "1px solid rgba(255,255,255,.35)" }}
            >
        ...
        {/* Social */}
        <div>
          <div style={labelStyles}>Follow Us</div>
          <div style={{ display: "flex", alignItems: "center" }}>
